...
let slider_about = new Swiper('.main-slider__body', {
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.button-nav__next',
		prevEl: '.button-nav__back',
	},
...
let slider_lots = new Swiper('.lot-swiper__body ', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.lot-swiper__next',
		prevEl: '.lot-swiper__prev',
	},
...
let slider_quotes = new Swiper('.quotes-swiper__body', {
...
var user_icon = document.querySelector('.action-header__user')
var body = document.querySelector('body')
user_icon.addEventListener("click", function(e) {
    var menu_user = document.querySelector('.action-header__option')
    menu_user.classList.toggle("_active")
   
});

document.documentElement.addEventListener("click",function(e){
    if(!e.target.closest('.header__action ')){
        console.log(e)
        var menu_user = document.querySelector('.action-header__option')
        menu_user.classList.remove('_active')
    }
} );
// Dynamic Adapt v.1
